...
class PlanningGraph():
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        action1_pre = node_a1.action.precond_pos
        action1_rem = node_a1.action.effect_rem
        action2_pre = node_a2.action.precond_pos
        action2_rem = node_a2.action.effect_rem
        if action2_rem and action2_rem[0] in action1_pre:
            return True
        if action1_rem and action1_rem[0] in action2_pre:
            return True
        return False
